...
namespace Catalog.API.Controllers
{
    ...
    public class ItemHateoasController : ControllerBase
    {
        ...
        public ItemHateoasController(ILinksService linkService, IItemService itemService)
        {
        ...
        public async Task<IActionResult> Get([FromQuery] int pageSize = 10, [FromQuery] int pageIndex = 0)
        {
            ...
            var model = new PaginatedItemResponseModel<ItemHateoasResponse>(pageIndex, pageSize, totalItems, hateoasResults);
            return Ok(model);
        }
